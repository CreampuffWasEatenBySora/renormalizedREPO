<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <x-input-label for="mname" :value="__('Middle Initial')" />
        ...
        <div>
            ...
            <x-text-input id="bday" class="block mt-1 w-full" type="date" name="bday" :value="old('bday')" required autofocus autocomplete="bday" />
